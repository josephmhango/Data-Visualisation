...
### 2.4 Polar Coordinates: Circles, Roses e.t.c.
...
> Implementation note: The **ggtern** extension adds ternary coordinates to ggplot. If not available, you can still *view* barycentric logic by constraining A+B+C=1 and drawing a filled triangle with `geom_polygon`.
